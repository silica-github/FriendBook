...
import com.youshibi.app.presentation.read.ReadAdapter;
...
public class BookDetailActivity extends MvpLoaderActivity<BookDetailContract.Presenter> implements BookDetailContract.View, View.OnClickListener {
    ...
    private void downloadBook(int i) {
        DataManager
                .getInstance()
                .getBookSectionContent(book.getId(), bookDetail.getLatestChapter().getChapterId(), i)
                .retryWhen(new RetryWithDelay(3, 3000))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new ProgressSubscriber<BookSectionContent>(this) {
                    ...
                    public void onError(Throwable e) {
                        super.onError(e);
                        ToastUtil.showToast("下载失败: " + AppException.getExceptionMessage(e));
                    }
