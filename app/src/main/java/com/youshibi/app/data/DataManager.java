...
//        hashMap.put("type", 100);
    ...
    public Observable<List<BookSectionItem>> getBookSectionList(String bookId,
        ...
        hashMap.put("action", "api.infolist");
        IStrategy iStrategy;
        if (updated) {
...
//                .getBookSectionList(bookId, hashMap)
    ...
    public Observable<BookSectionContent> getBookSectionContent(String bookId, String sectionId, int sectionIndex, String direction) {
        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap.put("aid", bookId);
        hashMap.put("cid", sectionId);
        hashMap.put("action", "api.read");
        return RequestClient
                .getServerAPI()
...
//        hashMap.put("type", 104);
        ...
        hashMap.put("action", "api.info");


        return RequestClient
                .getServerAPI()
                .getBookDetail(hashMap)
    ...
    public Observable<List<LatestChapter>> getLatestChapter(List<String> bookIds) {
        ...
        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap.put("bookid", bookIds.get(0));
        hashMap.put("type", 104);

        return RequestClient
                .getServerAPI()
                .getLatestChapter(hashMap)
